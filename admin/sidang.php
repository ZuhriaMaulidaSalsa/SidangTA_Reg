...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $jadwalSidang = $_POST['jadwal_sidang'];

    // Update jadwal_sidang sesuai dengan NIM dan nama yang diinputkan
    $sqlUpdateJadwal = "UPDATE multiuser SET jadwal_sidang = '$jadwalSidang' WHERE nim = '$nim' AND nama = '$namaLengkap'";
    $hasilUpdateJadwal = mysqli_query($koneksi, $sqlUpdateJadwal);

    if ($hasilUpdateJadwal) {
        echo "<script>alert('Jadwal sidang berhasil diinputkan.');</script>";
    } else {
        echo "<script>alert('Gagal memasukkan jadwal sidang.');</script>";
    }
}
    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            <div class="overview">
                ...
                <div class="title"><span class="text">Input Jadwal Sidang Mahasiswa</span> <br> <br><br>
            ...
            <div class="activity">
                <div class="activity-data">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group flex-nowrap">
                            <span class="input-group-text" id="addon-wrapping">JADWAL</span>
                            <input type="text" class="form-control" placeholder="Isi Jadwal Sidang" aria-label="Username" aria-describedby="addon-wrapping" name="jadwal_sidang">
                        </div> <br>
                        <div class="dropdown">
                            <div class="mb-3">
