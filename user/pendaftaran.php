    ...
    <section>
        ...
        <div class="dashboard" style="margin-top: -15px; box-sizing: border-box; font-family: 'Poppins', sans-serif;">
            <div class="dash-content">
                <div class="overview">
                    <div class="title">
                        <span class="text"><b>Data Pendaftaran</b></span>
                    </div>
                                ...
                                <table class="table table-bordered" style="text-align: left; width: 1220px;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="padding: 15px;">NAMA FILE PENDAFTARAN</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="padding: 15px;"><?php echo $baris['file_pendaftaran'] ?></td>
                                                <td style="padding: 15px;">
                                                    <a href="pdfs/<?php echo $baris['file_pendaftaran']; ?>" target="_blank"><button type="button" class="btn btn-primary"><span class="bi bi-box-arrow-up-right"></span> Open</button></a>
