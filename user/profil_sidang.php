        ...
        <div class="container-xl px-4 mt-4">
            ...
            <div class="row">
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">Jadwal Sidang TA</div>
                        <div class="card-body">
                            <!-- Isi konten hasil sidang disini -->
                            <?php
                            $query_jadwal = "SELECT `jadwal_sidang` FROM `multiuser` WHERE nim = '$nim';";
                            $hasil_jadwal = mysqli_query($koneksi, $query_jadwal);

                            if ($hasil_jadwal) {
                                $row_jadwal = mysqli_fetch_assoc($hasil_jadwal);
                                $jadwal_sidang = $row_jadwal['jadwal_sidang'];

                                echo "<p>" . $jadwal_sidang . "</p>";
                            } else {
                                echo "Error in query: " . mysqli_error($koneksi);
                            }
                            ?>
